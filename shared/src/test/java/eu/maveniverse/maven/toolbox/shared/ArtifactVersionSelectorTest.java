...
public class ArtifactVersionSelectorTest {
    ...
    void identity() {
        ...
        assertEquals("v1", ArtifactVersionSelector.identity().apply(new DefaultArtifact("g:a:v1"), List.of()));
    }

    @Test
    void last() {
        assertEquals("410.0.0-SNAPSHOT", ArtifactVersionSelector.last().apply(new DefaultArtifact("g:a:v1"), versions));
        assertEquals("v1", ArtifactVersionSelector.last().apply(new DefaultArtifact("g:a:v1"), List.of()));
    }

    @Test
    void prev() {
        assertEquals("3.1.0M1", ArtifactVersionSelector.prev().apply(new DefaultArtifact("g:a:3.1.0"), versions));
        assertEquals("v1", ArtifactVersionSelector.prev().apply(new DefaultArtifact("g:a:v1"), List.of()));
    }

    @Test
    void next() {
        assertEquals("3.0.2-alpha", ArtifactVersionSelector.next().apply(new DefaultArtifact("g:a:3.0.1"), versions));
        assertEquals("v1", ArtifactVersionSelector.next().apply(new DefaultArtifact("g:a:v1"), List.of()));
    }
    ...
    void sameMajor() {
        ...
        assertEquals("v1", ArtifactVersionSelector.major().apply(new DefaultArtifact("g:a:v1"), List.of()));
    }
    ...
    void sameMinor() {
        ...
        assertEquals("v1", ArtifactVersionSelector.minor().apply(new DefaultArtifact("g:a:v1"), List.of()));
    }
    ...
    void sameMajorNoPreviews() {
        ...
        assertEquals(
                "v1",
                ArtifactVersionSelector.noPreviews(ArtifactVersionSelector.major())
                        .apply(new DefaultArtifact("g:a:v1"), List.of()));
    }
    ...
    void contextualSnapshotsAndPreviews() {
        ...
        assertEquals(
                "v1-SNAPSHOT",
                ArtifactVersionSelector.contextualSnapshotsAndPreviews()
                        .apply(new DefaultArtifact("g:a:v1-SNAPSHOT"), List.of()));
    ...
    void parse() {
        ...
        assertEquals(
                artifact.getVersion(),
                ArtifactVersionSelector.build(versionScheme, Map.of(), "identity()")
                        .apply(artifact, versions));
        assertEquals(
                "2.0.0",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "first()")
                        .apply(artifact, versions));
        assertEquals(
                "410.0.0-SNAPSHOT",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "last()").apply(artifact, versions));
        assertEquals(
                "3.200.0-SNAPSHOT",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "major()")
                        .apply(artifact, versions));
        assertEquals(
                "3.0.2-alpha",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "minor()")
                        .apply(artifact, versions));
        assertEquals(
                "3.200.0-SNAPSHOT",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "noPreviews(major())")
                        .apply(artifact, versions));
        assertEquals(
                "3.0.1",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "noPreviews(minor())")
                        .apply(artifact, versions));
        assertEquals(
                "3.0.1",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "filtered(eq(3.0.1), last())")
                        .apply(artifact, versions));
        assertEquals(
                "400.0.0",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "noSnapshotsAndPreviews(last())")
                        .apply(artifact, versions));
        assertEquals(
                "3.100.0",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "noSnapshotsAndPreviews(major())")
                        .apply(artifact, versions));

        assertEquals(
                "401.0.0RC",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "contextualSnapshotsAndPreviews(last())")
        ...
        assertEquals(
                "3.101.0RC",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "contextualSnapshotsAndPreviews()")
                        .apply(artifact.setVersion("3.0.0-rc-1"), versions));
        assertEquals(
                "3.200.0-SNAPSHOT",
                ArtifactVersionSelector.build(versionScheme, Map.of(), "contextualSnapshotsAndPreviews()")
