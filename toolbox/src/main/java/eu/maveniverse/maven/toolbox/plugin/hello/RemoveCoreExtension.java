...
/**
 * Removes core extension.
 */
@CommandLine.Command(name = "remove-core-extension", description = "Removes core extension")
@Mojo(name = "remove-core-extension", requiresProject = false, threadSafe = true)
public class RemoveCoreExtension extends HelloProjectMojoSupport {
    /**
     * The extension GAV.
     */
    ...
    protected Result<Boolean> doExecute() throws Exception {
        ...
        try (ToolboxCommando.EditSession editSession = getToolboxCommando().createEditSession(extensionsXml)) {
            toolboxCommando.editExtensions(editSession, ToolboxCommando.Op.DELETE, List.of(extension)::stream);
        }
